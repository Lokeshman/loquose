...
#endif
#if NFX
using Lokesh.Data.Dapper.Extension;
...
namespace Lokesh.Repository.Initializer
{
    ...
    public class DbContext : IDisposable
    {
        ...
        public DbContext()
        {
            ...
            _factory = new SqlDbFactory(new DefaultDappererSettings());
        ...
        {
            _factory = new SqlDbFactory(connectionStringName);
        ...
        protected virtual void OnConfiguration(IDbFactory factory)
        {
        }
